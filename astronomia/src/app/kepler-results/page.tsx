...
export default function AstronomerReportPage() {
  ...
  useEffect(() => {
    if (targetName) {
      if (isCustom) {
        ...
        // Fetch from NASA API (TAP, then Python astroquery)
        setLoading(true);
        setError(null);
        setKeplerAnalysis(null);
  ...
  if (loading) {
    return (
      <div style={{ minHeight: "100vh", minWidth: "100vw", position: "relative", overflow: "hidden" }} data-page="kepler">
      ...
      <div style={{ 
        ...
        <div style={{ 
          ...
          <div style={{ marginBottom: 24 }}>
            <h1 style={{ margin: "0 0 8px 0", color: "#eef3fa", fontSize: 24, fontWeight: 700 }}>
              {wrapPastelLastWord("🚀 Johannes Kepler AI Analysis")}
            </h1>
            <p style={{ margin: "0 0 24px 0", color: "#8b9bb0", fontSize: 14, opacity: 0.8 }}>
          ...
          {keplerError && (
            <div style={{ 
              ...
              <div style={{ color: "#8b9bb0", fontSize: 12, opacity: 0.8 }}>
                {keplerError}
              </div>
            </div>
          )}
          ...
          {((isCustom ? graceHopperAnalysis : keplerAnalysis) && (isCustom ? graceHopperAnalysis?.success : keplerAnalysis?.success)) && (
            <div style={{ marginBottom: 24 }}>
              <h3 style={{ color: "#eef3fa", margin: "0 0 12px 0", fontSize: 16, fontWeight: 600 }}>
                  ...
                  components={{
                    ...
                    h2: ({ children }) => (
                      <h2 style={{ 
                        ...
                        borderBottom: "1px solid rgba(190, 214, 255, 0.14)",
                        paddingBottom: 6
                      }}>
                        {children}
                      </h2>
          ...
          <div style={{ marginBottom: 24 }}>
            ...
            <p style={{ color: "#8b9bb0", fontSize: 14, lineHeight: 1.6, margin: 0 }}>
          ...
          <div style={{
            ...
            <h4 style={{ color: "#7eb6ff", margin: "0 0 8px 0", fontSize: 14, fontWeight: 600 }}>
              🎯 Mission Status: {keplerAnalysis?.success ? "AI Analysis Complete" : "Ready for Launch"}
            </h4>
            <p style={{ margin: "0 0 12px 0", fontSize: 13, opacity: 0.9, color: "#8b9bb0" }}>
            ...
            {showChat && (
              <div style={{
                ...
                <div style={{
                  padding: 12,
                  borderBottom: "1px solid rgba(190, 214, 255, 0.12)",
                  background: "rgba(59,130,246,0.1)"
                }}>
                  <div style={{
                    display: "flex",
                  ...
                  {chatMessages.length === 0 && (
                    <div style={{
                      ...
                      <div style={{ marginBottom: 16, fontSize: 13 }}>
                        Ask questions about <strong style={{ color: "#eef3fa" }}>{targetName || "this exoplanet"}</strong>...
                      </div>
                    ...
                    >
                      <div style={{
                        background: message.role === 'user' 
                          ...
                          : "rgba(190, 214, 255, 0.08)",
                        color: message.role === 'user' ? "white" : "#8b9bb0",
                        padding: "8px 12px",
                        ...
                        {message.role === 'assistant' && (
                          <ReactMarkdown
                            components={{
                              ...
                              strong: ({ children }) => <strong style={{ color: "#eef3fa" }}>{children}</strong>,
                              em: ({ children }) => <em style={{ color: "#8b9bb0" }}>{children}</em>
                            }}
                          >
                            {message.content}
                          </ReactMarkdown>
                ...
                <div style={{
                  padding: 12,
                  borderTop: "1px solid rgba(190, 214, 255, 0.12)",
                  ...
                  <div style={{
                    ...
                    <input
                      ...
                      onBlur={(e) => {
                        e.currentTarget.style.borderColor = "rgba(190, 214, 255, 0.14)";
                      }}
                    />
                    <button
                      ...
                      style={{
                        background: chatInput.trim() && !chatLoading 
                          ? "linear-gradient(90deg, #3b82f6, #1d4ed8)"
                          : "rgba(190, 214, 255, 0.14)",
                        color: chatInput.trim() && !chatLoading ? "white" : "#8b9bb0",
                        border: "none",
                        borderRadius: 8,
                        padding: "8px 12px",
                        fontSize: 12,
          ...
          <div style={{ 
            ...
            {targetName ? (
              <NasaEyesEmbed
                ...
                hostname={hostname || exoplanetData?.hostname}
                full
              />
            ) : (
              <div style={{
