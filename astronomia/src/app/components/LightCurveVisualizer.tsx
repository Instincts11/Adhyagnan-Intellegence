  ...
  if (!lightCurveData) {
    return (
      <div style={{
        ...
        <div style={{ color: "#8b9bb0", fontSize: 16 }}>📊</div>
        <div style={{ color: "#8b9bb0", fontSize: 14, textAlign: "center" }}>
          No light curve data available
        </div>
        <div style={{ color: "#8b9bb0", fontSize: 12, textAlign: "center" }}>
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ color: "#8b9bb0", fontSize: 11, fontWeight: 600 }}>Period</div>
          <div style={{ color: "#eef3fa", fontSize: 14, fontWeight: 700 }}>
        ...
        <div style={{
          ...
          <div style={{ color: "#8b9bb0", fontSize: 11, fontWeight: 600 }}>Duration</div>
          <div style={{ color: "#eef3fa", fontSize: 14, fontWeight: 700 }}>
        ...
        <div style={{
          ...
          <div style={{ color: "#8b9bb0", fontSize: 11, fontWeight: 600 }}>Depth</div>
          <div style={{ color: "#eef3fa", fontSize: 14, fontWeight: 700 }}>
        ...
        <div style={{
          ...
          <div style={{ color: "#8b9bb0", fontSize: 11, fontWeight: 600 }}>Transits</div>
          <div style={{ color: "#eef3fa", fontSize: 14, fontWeight: 700 }}>
        ...
        <div style={{
          ...
          <div style={{ color: "#8b9bb0", fontSize: 11, fontWeight: 600 }}>Data Points</div>
          <div style={{ color: "#eef3fa", fontSize: 14, fontWeight: 700 }}>
        ...
        <div style={{
          ...
          <div style={{ color: "#8b9bb0", fontSize: 11, fontWeight: 600 }}>Noise Level</div>
          <div style={{ color: "#eef3fa", fontSize: 14, fontWeight: 700 }}>
