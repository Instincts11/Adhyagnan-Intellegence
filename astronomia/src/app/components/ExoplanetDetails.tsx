...
export default function ExoplanetDetails({ data, loading, error }: ExoplanetDetailsProps) {
  ...
  return (
    <div style={{ color: "#8b9bb0", fontSize: 14, lineHeight: 1.6 }}>
      {/* Basic Information */}
      ...
      <div style={{ marginBottom: 20 }}>
        ...
        <div style={{ display: "grid", gap: 8 }}>
          <div style={{ display: "flex", justifyContent: "space-between" }}>
            ...
            <span style={{ fontWeight: 500, color: data.pl_controv_flag ? "#ff6b6b" : "#7eb6ff" }}>
      ...
      {data.pl_rade && data.pl_eqt && (
        <div style={{ 
          ...
          <h3 style={{ color: "#7eb6ff", margin: "0 0 12px 0", fontSize: 16, fontWeight: 600 }}>
            Habitability Assessment
          </h3>
          <div style={{ fontSize: 13, lineHeight: 1.5 }}>
            {data.pl_rade > 0.8 && data.pl_rade < 1.4 && data.pl_eqt > 200 && data.pl_eqt < 350 ? (
              <div>
                <div style={{ color: "#7eb6ff", fontWeight: 600, marginBottom: 8 }}>
