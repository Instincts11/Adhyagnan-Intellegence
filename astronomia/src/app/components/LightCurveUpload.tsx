      ...
      {!uploading ? (
        <>
          ...
          <div
            ...
            style={{
              border: "2px dashed",
              borderColor: isDragActive ? "rgba(59,130,246,0.6)" : "rgba(190, 214, 255, 0.14)",
              borderRadius: 12,
              padding: "24px",
              textAlign: "center",
              cursor: "pointer",
          ...
          >
            ...
            {file ? (
              <div>
                ...
                <p style={{ color: "#eef3fa", fontWeight: 600, margin: "0 0 4px 0" }}>{file.name}</p>
                <p style={{ color: "#9ca3af", fontSize: 12, margin: 0 }}>{formatFileSize(file.size)}</p>
              </div>
            ) : (
              <>
                <p style={{ color: "#eef3fa", fontSize: 14, margin: "0 0 8px 0" }}>
          ...
          <details style={{ marginBottom: 16 }}>
            ...
            <div style={{ 
              ...
              <div style={{ color: "#9ca3af", fontSize: 11, marginBottom: 8 }}>
                <strong>CSV:</strong> Columns: <code style={{ background: "#10151f", padding: "2px 4px", borderRadius: 4 }}>time</code> (BJD), <code style={{ background: "#10151f", padding: "2px 4px", borderRadius: 4 }}>flux</code> (normalized), optional <code style={{ background: "#10151f", padding: "2px 4px", borderRadius: 4 }}>flux_err</code>
              </div>
        ...
        <div style={{ textAlign: "center", padding: "24px" }}>
          ...
          <h2 style={{ color: "#eef3fa", fontSize: 16, fontWeight: 600, margin: "0 0 16px 0" }}>
            ...
            {[
              ...
              <div key={idx} style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 8 }}>
                {progress >= step.threshold ? (
                  ...
                  <div style={{ width: 16, height: 16, border: "2px solid #8b9bb0", borderRadius: "50%" }} />
                )}
                <span style={{ 
