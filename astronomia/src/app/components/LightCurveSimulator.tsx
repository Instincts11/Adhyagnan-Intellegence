  ...
  return (
    <div style={{
      ...
      <div style={{ 
        ...
        {/* Period */}
        <div>
          <label style={{ color: "#8b9bb0", fontSize: 12, marginBottom: 4, display: "block" }}>
            Orbital Period (days)
          </label>
          <input
            type="number"
      ...
      <div style={{ textAlign: "center" }}>
        <button
          ...
          style={{
            ...
            color: isGenerating ? "#8b9bb0" : "#eef3fa",
            fontWeight: 600,
            fontSize: 14,
      ...
      <div style={{
        ...
        <div style={{ color: "#8b9bb0", fontSize: 11, marginBottom: 4 }}>
          ℹ️ Simulation Info
        </div>
        <div style={{ color: "#8b9bb0", fontSize: 10, lineHeight: 1.4 }}>
