...
export default function GraceHopperInputPage() {
  ...
  return (
    <div style={{ minHeight: "100vh", minWidth: "100vw", position: "relative", overflow: "auto" }} data-page="hopper">
      <StarfieldHyperdrive speed={0.05} warpBoost={1.2} />
      
      {/* Navigation Bar */}
      <NavigationBar pageTitle="Grace Hopper AI" />
      <PageHero copy={PAGE_COPY.hopper} />
        ...
        <div style={{ 
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={{ 
              ...
              <div>
                <h3 style={{ color: "#eef3fa", fontSize: 14, fontWeight: 600, margin: "0 0 12px 0" }}>
                  Mission & Host Star Data
                </h3>
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    <div>
                      ...
                      <div style={{ color: "#8b9bb0", fontSize: 11, opacity: 0.8 }}>This section is being enhanced with advanced visualization capabilities. Features and API integration to the ML model will be added (bugs remain to be fixed).</div>
                    </div>
                  </div>
                  ...
                  <div style={{ 
                      ...
                      >
                        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                          ...
                          <div>
                            ...
                            <div style={{ fontSize: 12, color: "#8b9bb0", opacity: 0.8 }}>
                    ...
                    <div style={{
                      ...
                      <div style={{ color: "#8b9bb0", fontSize: 12, marginBottom: 8 }}>
                        📋 Supported Data Formats
                      </div>
                      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 8 }}>
                        <div style={{ color: "#8b9bb0", fontSize: 11 }}>
                    ...
                    <div style={{ marginTop: 20 }}>
                      <div style={{
                        ...
                        <h4 style={{ color: "#eef3fa", fontSize: 14, marginBottom: 8, fontWeight: 600 }}>
                        ...
                        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(250px, 1fr))", gap: 8 }}>
                          {/* Model Information */}
                          <div>
                            <label style={{ color: "#8b9bb0", fontSize: 11, marginBottom: 4, display: "block" }}>
                              Predicted Label
                            </label>
                            <select
                              name="pred_label"
                      ...
                      <div style={{
                        ...
                        <div style={{ 
                          ...
                          <div style={{ display: "flex", alignItems: "center", marginBottom: 8 }}>
                            <span style={{ color: "#7eb6ff", fontSize: 16, marginRight: 8 }}>✅</span>
                            <span style={{ color: "#8b9bb0", fontSize: 12, fontWeight: 600 }}>Model Status</span>
                          </div>
                          <div style={{ color: "#eef3fa", fontSize: 11, marginBottom: 12, padding: "8px 12px", background: "rgba(74,222,128,0.1)", borderRadius: 4 }}>
                            Modèle chargé depuis: /content/drive/MyDrive/models/naruto_KOI_best.keras
                          </div>
                          
                          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(120px, 1fr))", gap: 8 }}>
                            <div style={{ textAlign: "center" }}>
                              <div style={{ color: "#7eb6ff", fontSize: 12, fontWeight: 600 }}>ROC-AUC</div>
                              <div style={{ color: "#eef3fa", fontSize: 16, fontWeight: 700 }}>0.7476</div>
                            </div>
                            <div style={{ textAlign: "center" }}>
                              <div style={{ color: "#7eb6ff", fontSize: 12, fontWeight: 600 }}>Accuracy</div>
                              <div style={{ color: "#eef3fa", fontSize: 16, fontWeight: 700 }}>0.6297</div>
                            </div>
                            <div style={{ textAlign: "center" }}>
                              <div style={{ color: "#7eb6ff", fontSize: 12, fontWeight: 600 }}>F1-macro</div>
                              <div style={{ color: "#eef3fa", fontSize: 16, fontWeight: 700 }}>0.6190</div>
                            </div>
                          </div>
                          
                          <div style={{ marginTop: 12, padding: "8px 12px", background: "rgba(6,12,26,0.6)", borderRadius: 4 }}>
                            <div style={{ color: "#8b9bb0", fontSize: 11, fontWeight: 600, marginBottom: 4 }}>Classification Report</div>
                            <div style={{ color: "#eef3fa", fontSize: 10, fontFamily: "monospace", lineHeight: 1.4 }}>
                              <div style={{ marginBottom: 4 }}>precision    recall  f1-score   support</div>
                              <div style={{ display: "flex", justifyContent: "space-between" }}>
                                <span style={{ color: "#7eb6ff" }}>0</span>
                              ...
                              <div style={{ borderTop: "1px solid rgba(190, 214, 255, 0.14)", marginTop: 4, paddingTop: 4 }}>
                ...
                <div style={{
                  ...
                  <div style={{ 
                    ...
                    <div style={{
                      ...
                      <div style={{ 
                        color: mlPrediction.pred_label === "CONFIRMED" ? "#7eb6ff" : 
                    ...
                    <div style={{
                      ...
                      <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                          <span style={{ color: "#7eb6ff", fontSize: 11 }}>CONFIRMED:</span>
                          <span style={{ color: "#eef3fa", fontSize: 11 }}>{(mlPrediction.p_CONFIRMED * 100).toFixed(1)}%</span>
                        </div>
                        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                          <span style={{ color: "#fbbf24", fontSize: 11 }}>CANDIDATE:</span>
                          <span style={{ color: "#eef3fa", fontSize: 11 }}>{(mlPrediction.p_CANDIDATE * 100).toFixed(1)}%</span>
                        </div>
                        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                          <span style={{ color: "#ef4444", fontSize: 11 }}>FALSE POSITIVE:</span>
                          <span style={{ color: "#eef3fa", fontSize: 11 }}>{(mlPrediction.p_FALSE_POSITIVE * 100).toFixed(1)}%</span>
                        </div>
                      </div>
                    </div>
                  ...
                  <div style={{
                    ...
                    <div style={{ color: "#8b9bb0", fontSize: 12, marginBottom: 4 }}>
                      🤖 AI Interpretation
                    </div>
                    <div style={{ color: "#8b9bb0", fontSize: 11 }}>
                  ...
                  <div style={{ marginTop: 12 }}>
                    <div style={{ color: "#8b9bb0", fontSize: 14, marginBottom: 12, fontWeight: 600, textAlign: "left" }}>
                      🔬 ML Precision Details
                    </div>
                    <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: 8 }}>
                      ...
                      <div style={{
                        ...
                        <div style={{ color: "#8b9bb0", fontSize: 11, fontWeight: 600, marginBottom: 4 }}>Model Architecture</div>
                        <div style={{ color: "#eef3fa", fontSize: 10, marginBottom: 4 }}>HistGradientBoostingClassifier Pipeline</div>
                        <div style={{ color: "#8b9bb0", fontSize: 9 }}>
                      ...
                      <div style={{
                        ...
                        <div style={{ color: "#8b9bb0", fontSize: 11, fontWeight: 600, marginBottom: 8, textAlign: "center" }}>Performance Metrics</div>
                        <div style={{ display: "flex", flexDirection: "column", gap: 6, alignItems: "center" }}>
                          <div style={{ textAlign: "center" }}>
                            <div style={{ color: "#7eb6ff", fontSize: 10, fontWeight: 600 }}>F1-macro</div>
                            <div style={{ color: "#eef3fa", fontSize: 11 }}>0.831 ± 0.002</div>
                          </div>
                          <div style={{ textAlign: "center" }}>
                            <div style={{ color: "#7eb6ff", fontSize: 10, fontWeight: 600 }}>Balanced Acc</div>
                            <div style={{ color: "#eef3fa", fontSize: 11 }}>0.834 ± 0.003</div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div style={{
                        ...
                        <div style={{ color: "#8b9bb0", fontSize: 11, fontWeight: 600, marginBottom: 4 }}>Training Data & Validation</div>
                        <div style={{ color: "#eef3fa", fontSize: 9 }}>
            ...
            <div style={{ display: "flex", gap: 12, flexDirection: "column", marginTop: 40 }}>
              ...
              <button
                ...
                style={{
                  ...
                  color: navigating ? "#8b9bb0" : "#eef3fa",
                  fontWeight: 600,
                  fontSize: 16,
      ...
      <CtaBand {...PAGE_COPY.hopper.cta} />

      <div style={{ position: "fixed", inset: 0, zIndex: 0, pointerEvents: "none", background: "radial-gradient(1200px 600px at 50% 50%, transparent, rgba(0,0,0,0))" }} />
